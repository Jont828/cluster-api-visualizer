...
helm install --repo https://raw.githubusercontent.com/Jont828/cluster-api-visualizer/main/helm/repo cluster-api-visualizer --generate-name --set kubeconfig="$KUBECONFIG_DATA" || exit 1
